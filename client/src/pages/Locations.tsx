      ...
      <div className="container py-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            {/* Map */}
            <div className="card-surface rounded-2xl overflow-hidden h-72 bg-gray-100">
              {selected ? (
                <iframe
                      ...
                      <div>
                        ...
                        {typeof selected.openingHours === "object" ? (
                          <div className="text-sm text-gray-700 space-y-0.5">
                            {Object.entries(
                              selected.openingHours as Record<string, string>
                            ).map(([day, hours]) => (
                              <div key={day} className="flex gap-2">
                                <span className="capitalize font-medium text-gray-600 w-20">
                                  {day}:
                                </span>
                                <span>{hours}</span>
                              </div>
