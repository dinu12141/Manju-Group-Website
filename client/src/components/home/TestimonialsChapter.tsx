...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    initials: "SP",
    product: "Manju Books",
    productColor: "bg-violet-50 text-violet-700 border-violet-100",
    avatarBg: "#7C3AED",
    text: "Manju Exercise books have excellent paper quality. They survive the entire school year for all three of my children — no tearing, no ink bleed. Best in Sri Lanka.",
    stars: 5,
  },
  {
